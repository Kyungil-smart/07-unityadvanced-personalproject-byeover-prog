...
{
    [CreateAssetMenu(fileName = "StageSequence_", menuName = "리듬 도사/Stage Sequence Data")]
    public sealed class SequencerStageDataSO : ScriptableObject
    {
        ...
        [Tooltip("비워두면 Lane1Prefab 1개만 사용, 넣으면 랜덤으로 선택")]
        public GameObject[] Lane1Prefabs;
        [Tooltip("1은 스폰, 0은 빈 공간입니다. (엇박이나 빈 공간을 만들어보세요)")]
        public string Lane1Pattern = "0000100000001000";

        [Header("2번 레인 (멧돼지)")]
        public GameObject Lane2Prefab;
        [Tooltip("비워두면 Lane2Prefab 1개만 사용, 넣으면 랜덤으로 선택")]
        public GameObject[] Lane2Prefabs;
        public string Lane2Pattern = "1000000010000000";

        [Header("3번 레인 (가운데 아래 - 유령)")]
        public GameObject Lane3Prefab;
        [Tooltip("비워두면 Lane3Prefab 1개만 사용, 넣으면 랜덤으로 선택")]
        public GameObject[] Lane3Prefabs;
        public string Lane3Pattern = "1000100010001000";

        [Header("4번 레인 (맨 아래 - 뱀)")]
        public GameObject Lane4Prefab;
        [Tooltip("비워두면 Lane4Prefab 1개만 사용, 넣으면 랜덤으로 선택")]
        public GameObject[] Lane4Prefabs;
