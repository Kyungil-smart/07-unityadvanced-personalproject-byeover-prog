...
namespace _Game.Scripts.Rhythm
{
    ...
    public sealed class HitBarSpawner2D : MonoBehaviour
    {
        [Header("참조")]
        [Tooltip("바 풀")]
        [SerializeField] private HitBarPool2D barPool;
        ...
        private void Awake()
        {
            if (barPool == null) barPool = FindFirstObjectByType<HitBarPool2D>();
